...
class Container(DefaultObject):
    ...
    def at_object_creation(self):
        ...
        # find out).
        self.db.get_err_msg = "This is too heavy to pick up."
    def at_object_leave(self,obj, target_location):   #- called when an object leaves this object in any fashion
    def at_object_receive(self,obj, source_location): #- called when this object receives another object
    """
    pass
